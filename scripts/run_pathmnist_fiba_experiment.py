...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--trigger-kind", default="fiba_amplitude")
    parser.add_argument("--horizontal-frequency", type=int, default=0)
    parser.add_argument("--vertical-frequency", type=int, default=0)
    parser.add_argument("--secondary-horizontal-frequency", type=int, default=0)
    parser.add_argument("--secondary-vertical-frequency", type=int, default=0)
    parser.add_argument("--window-center-x", type=float, default=0.0)
    parser.add_argument("--window-center-y", type=float, default=0.0)
    parser.add_argument("--window-sigma", type=float, default=0.0)
